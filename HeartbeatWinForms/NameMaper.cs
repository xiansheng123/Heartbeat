...
namespace HeartbeatWinForms
{
    public class NameMapper
    {
        ...
        public List<string> NameMappingPartial(RichTextBox richTextBox1, List<string> originalLines,
            ref List<string> errorList)
        {
            ...
            return NameMapping(richTextBox1,newLines, ref errorList);
        }


        public List<string> NameMapping(RichTextBox richTextBox1, List<string> originalLines,
            ref List<string> errorList)
        {
            ...
            foreach (string line in originalLines)
            {
                ...
                if (line.Contains("英"))
                {
                    ...
                    richTextBox1.AppendText(count + ")" + newline + "\r\n");
                }
                else
                {
                    ...
                    {
                        richTextBox1.AppendText(count + ")" + str+ "\r\n");
                    }
                }
            }
